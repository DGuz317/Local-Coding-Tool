# RepoLens MCP v0.2 Release Checklist
...
- `suggest_reading_order` returns bounded recommendations for a real task.
...
Do not add or require these for v0.2 release readiness:
