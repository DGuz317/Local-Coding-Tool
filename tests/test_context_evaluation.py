...
def test_context_evaluation_runs_manifest_cases_with_metrics() -> None:
    ...
    assert data["summary"]["total_cases"] == 25
    assert data["summary"]["passed_cases"] == 25
    ...
    assert data["corpora"] == {
        ...
        "release_blocking": {"failed_cases": 0, "passed_cases": 24, "total_cases": 24},
    }
    ...
    assert data["local_savings_summary"]["case_count"] == 25
